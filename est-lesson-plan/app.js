...
const FULL_COURSE_OUTLINES = {
  ...
  'Computer – Desktop Publishing': {
    meta: { title: 'Desktop Publishing (MS Publisher, Adobe Photoshop, Canva, Adobe InDesign)', duration: '12 Weeks', creditHours: '240 Hours', daysPerWeek: '5 Days', approach: 'Creative and practical design-focused learning' },
    ...
    modules: [
      ...
      { name: 'Module 11 – Adobe InDesign – Basics', objective: 'Learn the InDesign interface, master pages, frames and typography.', days: ['InDesign interface, pages and master pages', 'Columns, frames and typography', 'Multi-page layout practice', 'Magazine/newsletter layout design', 'Practical: Create a 2–4 page magazine/newsletter'], weeklyTask: 'Create a 2–4 page magazine/newsletter layout' },
      { name: 'Module 12 – Adobe InDesign – Advanced & Final Project', objective: 'Apply styles, tables, preflight and PDF export for professional publications.', days: ['Styles, page numbering and tables in InDesign', 'Images, links, preflight and PDF export', 'Final project planning and design', 'Professional magazine/brochure design', 'Practical: Design a professional magazine/brochure and present final portfolio'], weeklyTask: 'Design a professional magazine/brochure and present final DTP portfolio' },
    ],
    outcomes: ['Understand the fundamentals of Desktop Publishing', 'Create professional documents using MS Publisher', 'Edit and manipulate images using Adobe Photoshop', 'Design creative digital content using Canva', 'Create professional page layouts using Adobe InDesign', 'Apply typography, colour, images, alignment and layout principles', 'Prepare brochures, flyers, posters, invitations, newsletters and magazines', 'Export designs for print and digital use', 'Develop a professional DTP design portfolio'],
  },
...
const FALLBACK_CURRICULUM = {
  ...
  'Computer – Desktop Publishing': [
    ...
    { lesson: 'Adobe InDesign – Basics',                   topics: ['InDesign interface, pages and master pages', 'Columns, frames and typography', 'Multi-page layout practice', 'Magazine/newsletter layout design', 'Practical: Create a 2–4 page magazine/newsletter'] },
    { lesson: 'Adobe InDesign – Advanced & Final Project', topics: ['Styles, page numbering and tables in InDesign', 'Images, links, preflight and PDF export', 'Final project planning and design', 'Professional magazine/brochure design', 'Practical: Design a professional magazine/brochure and present final portfolio'] },
  ],
  'Computer – Tally': [
