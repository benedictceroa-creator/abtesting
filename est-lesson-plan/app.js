...
const FULL_COURSE_OUTLINES = {
  ...
  'Early Childhood – Module 1': {
    meta: { title: 'Early Childhood Care and Education – Module 1: Concepts of Child Development', institution: 'Asha Jyothi Employable Skills Training – Medchal Branch', creditHours: '240 Hours', duration: '13 Weeks', daysPerWeek: '5 Days' },
    description: 'This course explores the growth, development, learning, and behavior of children from birth to eight years of age. It provides students with an understanding of the major areas of child development, including physical, motor, cognitive, language, emotional, and social development. The course examines the factors that influence children\'s development, including heredity, maturation, learning, family, culture, environment, nutrition, and social experiences. It also introduces students to major developmental concepts and theories and develops their ability to observe children and identify developmental milestones. The course further focuses on preschool education, classroom environment, teaching-learning materials, activity planning, discipline, habit formation, behavioral problems, school readiness, evaluation, and the responsibilities of preschool teachers.',
    courseObjectives: [
      'Understand the meaning, principles, patterns, and stages of growth and development from birth to eight years.',
      'Differentiate between growth and development and understand their interrelationship.',
      'Identify the major factors influencing children\'s development.',
      'Understand physical, motor, cognitive, language, emotional, and social development.',
      'Identify important developmental milestones in young children.',
      'Understand the importance of the early years and the characteristics and needs of preschool children.',
      'Explain the importance, aims, and objectives of preschool education.',
      'Understand the role of parents, teachers, family, and environment in child development.',
      'Develop skills for observing and recording children\'s developmental and behavioral characteristics.',
      'Understand habit formation, discipline, and appropriate techniques for guiding young children.',
      'Identify common behavioral problems and understand appropriate educational approaches.',
      'Develop awareness of conditions such as Autism Spectrum Disorder (ASD) and Attention-Deficit/Hyperactivity Disorder (ADHD).',
      'Understand the physical requirements and management of a preschool.',
      'Identify appropriate teaching-learning materials and activity areas for young children.',
      'Develop skills in planning age-appropriate preschool activities.',
      'Understand school readiness and different types of readiness.',
      'Develop basic skills in evaluation and assessment of preschool children.',
      'Apply theoretical knowledge through practical activities, assignments, observations, role plays, and lesson planning.',
    ],
    modules: [
      { name: 'Module 1 – Introduction to Growth and Development', week: 'Week 1 (Jun 15th – Jun 19th)', objective: 'Understand the meaning, differences, and principles of growth and development.', days: ['Meaning of growth and development', 'Differences between growth and development', 'Principles of growth and development', 'Critical periods in child development and recap of key words and concepts', 'Activity: Students introduce themselves and share their understanding of childhood development'] },
      { name: 'Module 2 – Factors Influencing Growth and Development', week: 'Week 2 (Jun 22nd – Jun 26th)', objective: 'Identify and discuss the factors that influence children\'s growth and development.', days: ['Factors influencing growth and development', 'Discussion of real-life situations based on developmental factors', 'Maturation and learning', 'Discussion on how biological growth and environment interact to foster child development', 'Assignment: Observe any two children and note differences in physical or emotional maturity'] },
      { name: 'Module 3 – Physical and Motor Development', week: 'Week 3 (Jun 29th – Jul 3rd)', objective: 'Understand the patterns and factors of physical and motor development.', days: ['Meaning and patterns of physical development', 'Factors influencing physical development', 'Meaning and types of motor development', 'Factors influencing motor development', 'Slip Test: Unit I'] },
      { name: 'Module 4 – Emotional, Social, Cognitive and Language Development', week: 'Week 4 (Jul 6th – Jul 10th)', objective: 'Identify the types and factors of emotional and social development.', days: ['Positive and negative emotions', 'Factors influencing emotional development', 'Meaning and patterns of social development', 'Factors influencing social development', 'Oral Test: Motor and emotional development'] },
      { name: 'Module 5 – Cognitive and Language Development', week: 'Week 5 (Jul 13th – Jul 17th)', objective: 'Explain cognitive skills, speech types, and factors affecting language development.', days: ['Meaning and skills of cognitive development', 'Factors influencing cognitive development', 'Speech and types of speech; tasks involved in developing speech skills', 'Factors influencing speech and common speech disorders', 'Activity: Reading books, singing songs, and narrating daily routines'] },
      { name: 'Module 6 – Preschool Children, Habit Formation and Discipline', week: 'Week 6 (Jul 27th – Jul 31st)', objective: 'Understand the importance of the early years, preschool education, and habit formation.', days: ['Importance of early years and characteristics of preschool children', 'Developmental needs of preschool children', 'Significance and need for preschool education', 'Aims and objectives of preschool education', 'Meaning and importance of habit formation'] },
      { name: 'Module 7 – Habit Formation and Discipline', week: 'Week 7 (Aug 3rd – Aug 7th)', objective: 'Understand disciplinary techniques and the role of parents and teachers in forming good habits.', days: ['Role of parents and teachers in inculcating good habits in children', 'Interactive questions and answers for teaching good habits', 'Need and importance of discipline and techniques for inculcating discipline', 'Authoritarian, permissive, and democratic disciplinary techniques', 'Slip Test'] },
      { name: 'Module 8 – Behavioural Problems and Developmental Conditions', week: 'Week 8 (Aug 10th – Aug 14th)', objective: 'Identify types of behavioral problems and develop awareness of ASD and ADHD.', days: ['Meaning and causes of behavioral problems', 'Different types of behavioral problems', 'Identification and discussion of common behavioral problems', 'Autism Spectrum Disorder (ASD)', 'Attention-Deficit/Hyperactivity Disorder (ADHD)'] },
      { name: 'Module 9 – Preschool Organization and Physical Setup', week: 'Week 9 (Aug 17th – Aug 21st)', objective: 'Understand the physical setup, role of the principal, and methods of preschool management.', days: ['Physical setup of preschool – introduction', 'Role and responsibilities of the principal', 'Preschool methods', 'Selection of site for preschool', 'Slip Test'] },
      { name: 'Module 10 – Preschool Building and Learning Resources', week: 'Week 10 (Aug 24th – Aug 28th)', objective: 'Identify building requirements, activity areas, and teaching-learning materials for preschool.', days: ['Building requirements for preschool', 'Activity areas', 'Early Childhood Education (ECE) requirements', 'Types of teaching-learning materials', 'Activity: Prepare an activity for fine motor development and cognitive development'] },
      { name: 'Module 11 – Preschool Management, Planning and Teacher Responsibilities', week: 'Week 11 (Aug 31st – Sep 4th)', objective: 'Understand preschool records, equipment care, and responsibilities of a preschool teacher.', days: ['Records to be maintained in preschool', 'Care of preschool equipment', 'Introduction to management and planning of preschool activities', 'Responsibilities of a preschool teacher', 'Assignment: Prepare a Teacher\'s Day programme schedule'] },
      { name: 'Module 12 – Preschool Programme Planning, Readiness and Evaluation', week: 'Week 12 (Sep 7th – Sep 11th)', objective: 'Understand programme planning types, school readiness, and evaluation techniques.', days: ['Types of programme planning in preschool', 'Preschool activities', 'Meaning and importance of different types of readiness', 'Key aspects of a teacher\'s role and techniques of evaluation', 'Assignment: Prepare a question paper for summative examination for Nursery, LKG, and UKG'] },
      { name: 'Module 13 – Practical Application, School Readiness and Lesson Planning', week: 'Week 13 (Sep 14th – Sep 18th)', objective: 'Apply course concepts through role plays, assignments, and sensory activities.', days: ['Activity: Organize a role play of a Parent-Teacher Meeting', 'Assignment: Write about school-readiness activities children should acquire before entering formal schooling', 'Assignment: Prepare lesson plans based on the topics given', 'Activity: Prepare and demonstrate an activity using a sensory bin', 'Slip Test / Final Review: Course concepts and practical application'] },
    ],
    teachingMethods: ['Classroom lectures', 'Interactive discussions', 'Question-and-answer sessions', 'Demonstrations', 'Case studies', 'Child-observation activities', 'Role plays', 'Group activities', 'Individual assignments', 'Practical activities', 'Lesson-plan preparation', 'Teaching-learning material preparation', 'Sensory activities', 'Slip tests', 'Oral tests', 'Practical assessments'],
    assessmentPlan: [
      { item: 'Weekly Activities', weight: '10%' },
      { item: 'Practical Exercises', weight: '40%' },
      { item: 'Assignments', weight: '10%' },
      { item: 'Sensory & Experiential Activities', weight: '15%' },
      { item: 'Final Written Examination', weight: '25%' },
    ],
    outcomes: [
      'Understand developmental milestones and observe children\'s behavior and development.',
      'Identify factors influencing physical, motor, cognitive, language, emotional, and social development.',
      'Plan age-appropriate learning experiences and prepare teaching-learning materials.',
      'Support positive habits, discipline, and behavior in young children.',
      'Identify common behavioral problems and developmental conditions such as ASD and ADHD.',
      'Understand the physical setup, management, and records of a preschool.',
      'Develop skills in programme planning, school readiness, and evaluation.',
      'Participate effectively in preschool teaching through practical activities and lesson planning.',
    ],
  },

  'Early Childhood – Module 2': {
    meta: { title: 'Early Childhood Care and Education – Module 2: Early Childhood Health and Nutrition', institution: 'Asha Jyothi Employable Skills Training – Medchal Branch', creditHours: '240 Hours', duration: '11 Weeks', daysPerWeek: '5 Days' },
    description: 'This module introduces learners to the basic principles of nutrition, health, common childhood ailments, communicable diseases, and first aid relevant to preschool children. It emphasizes practical knowledge and skills needed to promote the health, safety, nutrition, and well-being of young children in preschool settings. Learners will engage in discussions, role plays, meal-planning activities, chart preparation, assignments, demonstrations, and practical activities.',
    courseObjectives: [
      'Explain the need and importance of nutrition during early childhood.',
      'Identify and differentiate between macronutrients and micronutrients.',
      'Explain the concept of a balanced diet and nutritional deficiency diseases.',
      'Plan and prepare balanced meals suitable for preschool children.',
      'Describe recommended dietary requirements for preschool children.',
      'Explain the meaning and importance of health in preschool children.',
      'Identify common communicable diseases and common ailments affecting preschool children.',
      'Describe methods for preventing communicable diseases and common childhood ailments.',
      'Explain the role of preschool teachers in promoting children\'s health and well-being.',
      'Identify appropriate precautions when caring for a sick child.',
      'Explain the meaning, importance, and basic principles of first aid.',
      'Identify the contents of a first aid box.',
      'Demonstrate basic first aid procedures appropriate for common childhood emergencies.',
      'Develop awareness of health, nutrition, safety, and hygiene practices in preschool settings.',
    ],
    modules: [
      { name: 'Module 1 – Introduction to Nutrition', week: 'Week 1 (Sep 21st – Sep 25th)', objective: 'Understand the importance of nutrition, types of nutrients, and balanced diet concepts.', days: ['Need and importance of nutrition', 'Macronutrients and micronutrients', 'Discussion of macronutrients and micronutrients', 'Balanced diet and nutritional deficiency diseases', 'Activity: Nutrient Sorting Game'] },
      { name: 'Module 2 – Balanced Diet for Preschool Children', week: 'Week 2 (Sep 28th – Oct 2nd)', objective: 'Plan and prepare balanced meals appropriate for preschool children.', days: ['Recapitulation', 'Planning balanced meals for preschool children', 'Preparation and serving of a balanced meal for children', 'Recommended Dietary Allowance (RDA) for preschool children', 'Gandhi Jayanthi (Holiday)'] },
      { name: 'Module 3 – Health of the Preschool Child', week: 'Week 3 (Oct 5th – Oct 9th)', objective: 'Define health and identify common communicable diseases and their prevention.', days: ['Introduction to health of the preschool child', 'Definition of health', 'Common communicable diseases', 'Common communicable diseases – causes, signs, and prevention', 'Role play on communicable diseases'] },
      { name: 'Module 4 – Common Ailments in Preschool Children', week: 'Week 4 (Oct 12th – Oct 16th)', objective: 'Identify common childhood ailments and their signs, symptoms, and prevention.', days: ['Common ailments in preschool children', 'Assignment: Write about any one childhood ailment', 'Common ailments – signs and symptoms', 'Discussion on prevention of common ailments', 'Slip test'] },
      { name: 'Module 5 – Promotion of Child Health in Preschool', week: 'Week 5 (Oct 19th – Oct 23rd)', objective: 'Understand the role of preschool in promoting health and caring for sick children.', days: ['Role of preschool in promoting children\'s health', 'Precautions for caring for a sick child', 'Activity: Prepare a chart showing precautions for caring for a sick child', 'Recapitulation', 'Slip test'] },
      { name: 'Module 6 – First Aid and Safety', week: 'Week 6 (Oct 26th – Oct 30th)', objective: 'Understand the meaning, importance, and contents of first aid.', days: ['Introduction to first aid', 'Definition of first aid', 'Importance of first aid', 'Contents of a first aid box', 'Practical Activity: Prepare a first aid box'] },
      { name: 'Module 7 – First Aid Procedures', week: 'Week 7 (Nov 2nd – Nov 6th)', objective: 'Demonstrate basic first aid procedures for common childhood injuries.', days: ['Introduction to basic first aid procedures', 'First aid procedures for common childhood injuries', 'Assignment: Write about any two first aid procedures to be followed', 'Recapitulation', 'Recapitulation'] },
      { name: 'Module 8 – Internship: Observation of Child Growth and Development', week: 'Week 8 (Nov 9th – Nov 13th)', objective: 'Observe and record children\'s growth, development, and behavioral patterns.', days: ['Observation of physical growth and motor development of preschool children', 'Observation of social, emotional, cognitive, and language development', 'Identification of individual differences among preschool children', 'Observation of habit formation, discipline, and behavioral patterns', 'Activity: Prepare a child development observation record'] },
      { name: 'Module 9 – Internship: Programme Planning, Evaluation and Practical Examination', week: 'Week 9 (Nov 23rd – Nov 27th)', objective: 'Plan preschool programmes, conduct activities, and evaluate children\'s progress.', days: ['Preparation of a daily/weekly preschool programme', 'Conducting activities for physical, cognitive, language, social, and emotional development', 'Observation of children\'s readiness and participation in activities', 'Evaluation of children\'s learning and developmental progress', 'Practical examination, viva voce, and submission of internship records'] },
      { name: 'Module 10 – Observation and Assessment of Preschool Children', week: 'Week 10 (Nov 30th – Dec 5th)', objective: 'Observe and document children\'s development, health, and learning in a preschool setting.', days: ['Observation of the preschool classroom environment and daily routine', 'Observation of children\'s physical, social, emotional, and language development', 'Identification of children\'s health, hygiene, and nutritional practices', 'Practical activity: Prepare an observation record for one preschool child', 'Assessment: Child observation record and discussion'] },
      { name: 'Module 11 – Internship Practical Examination and Evaluation', week: 'Week 11 (Dec 7th – Dec 11th)', objective: 'Demonstrate practical skills in meal planning, first aid, and internship record submission.', days: ['Practical examination: Planning and serving a balanced meal for preschool children', 'Practical examination: Demonstration of selected first-aid procedures', 'Viva voce on nutrition, child health, common ailments, and safety', 'Submission and presentation of internship records, observation reports, and assignments', 'Final internship assessment and feedback'] },
    ],
    teachingMethods: ['Lecture-cum-Discussion Method', 'Question-and-Answer Method', 'Demonstration Method', 'Activity-Based Learning', 'Role Play Method', 'Storytelling Method', 'Brainstorming Method', 'Practical/Experiential Learning', 'Visual-Aid Method – Use of charts, pictures, flashcards, food models, posters, and videos', 'Group Discussion and Collaborative Learning', 'Assignment Method', 'Recapitulation and Quiz Method', 'Observation Method', 'Assessment Method'],
    assessmentPlan: [
      { item: 'Weekly Activities', weight: '10%' },
      { item: 'Practical Laboratory Exercises', weight: '40%' },
      { item: 'Assignments', weight: '10%' },
    ...
    outcomes: [
      'Explain the importance of nutrition and identify macronutrients and micronutrients.',
      'Plan and prepare balanced meals appropriate for preschool children.',
      'Identify common communicable diseases and childhood ailments and their prevention.',
      'Explain the role of preschool in promoting children\'s health and hygiene.',
      'Demonstrate first aid procedures for common childhood injuries.',
      'Observe and record children\'s physical, social, emotional, and language development.',
      'Plan and conduct age-appropriate preschool activities and evaluate children\'s progress.',
      'Develop awareness of health, nutrition, safety, and hygiene in preschool settings.',
    ],
  },

  'Pharmacy Assistant': {
    meta: { title: 'Pharmacy Assistant', institution: 'Asha Jyothi Employable Skills Training – Medchal Branch', creditHours: '240 Hours', duration: '26 Weeks', daysPerWeek: '5 Days' },
    description: 'The 6-Month Pharmacy Assistant Course is a comprehensive, hands-on training program designed to equip students with the essential knowledge, practical skills, professional ethics, and workplace competencies required to support qualified pharmacists in hospitals, community pharmacies, clinics, and other healthcare settings. The course combines theory, practical demonstrations, activity-based learning, assessments, and internship training. Students are introduced to basic anatomy and physiology, pharmacy and drug concepts, dosage forms, prescriptions, medicine safety, OTC medicines, drug categories, inventory management, documentation, first aid, basic clinical measurements, and professional communication.',
    courseObjectives: [
      'Develop job-oriented skills required for pharmacy assistant roles.',
      'Understand the basic functions and responsibilities of a pharmacy assistant.',
      'Support qualified pharmacists in day-to-day pharmacy operations.',
      'Understand the safe handling, storage, arrangement, and disposal of medicines.',
      'Assist in maintaining pharmacy inventory and stock records.',
      'Understand the process of receiving medicines and preparing purchase requirements.',
      'Assist in handling prescriptions under appropriate professional supervision.',
      'Understand brand names, generic names, ingredients, dosage forms, and routes of administration.',
      'Recognize common medication errors, LASA medicines, drug interactions, and contraindications.',
      'Develop basic patient communication and counselling skills.',
      'Understand OTC medicines and the importance of responsible self-medication practices.',
      'Understand basic clinical measurements such as blood pressure and blood glucose monitoring.',
      'Develop basic first-aid, bandaging, and emergency-support skills.',
      'Understand pharmacy documentation, stock ledgers, purchase records, and sales records.',
      'Develop basic computer skills for pharmacy data maintenance.',
      'Understand pharmaceutical ethics, professional conduct, and relevant drug regulations.',
      'Develop practical workplace skills through internship experience.',
      'Promote safe medicine practices and public health awareness.',
    ],
    modules: [
      { name: 'Module 1 – Pharmacy Orientation and Role of a Pharmacy Assistant', week: 'Week 1 (Jun 15th – Jun 19th)', objective: 'Understand the role and responsibilities of a pharmacy assistant and explore pharmacy opportunities.', days: ['Course Orientation', 'Introduction to pharmacy and its opportunities', 'Hospital and departments', 'Role and responsibilities of a pharmacy assistant', 'Activity: "Know Your Pharmacy" – Pharmacy Assistant Role-Play'] },
      { name: 'Module 2 – Basic Anatomy, Physiology and Human Body Systems', week: 'Week 2 (Jun 22nd – Jun 27th)', objective: 'Understand basic anatomy, physiology, human organ systems, and blood pressure.', days: ['Introduction to basic anatomy and physiology', 'Human body – organ systems and functions', 'Various organ systems and their functions', 'Blood pressure – introduction and types', 'Activity/Slip Test: Human Body BINGO Game'] },
      { name: 'Module 3 – Blood Pressure Monitoring and Haematological Laboratory Tests', week: 'Week 3 (Jun 29th – Jul 3rd)', objective: 'Monitor blood pressure and interpret haematological laboratory test results.', days: ['Monitoring BP and precautions', 'Practical: Blood pressure monitoring', 'Clinical laboratory tests and interpretation – haematological tests', 'Second class of haematological tests', 'Practical/Slip Test: Measuring random blood sugar and performing CTBT test'] },
      { name: 'Module 4 – Renal, Thyroid and Cardiac Function Tests & Fluid-Electrolyte Balance', week: 'Week 4 (Jul 6th – Jul 10th)', objective: 'Understand renal, thyroid, and cardiac function tests and fluid-electrolyte balance.', days: ['Renal function tests', 'Thyroid function tests', 'Tests associated with cardiac disorders', 'Fluid electrolyte balance', 'Activity/Slip Test: Flash cards game on Electrolytes'] },
      { name: 'Module 5 – Pulmonary Function Tests, Pharmacy Law and Pharmaceutical Ethics', week: 'Week 5 (Jul 13th – Jul 17th)', objective: 'Understand pulmonary function tests, pharmacy law, and pharmaceutical ethics.', days: ['Pulmonary function tests', 'Introduction to pharmacy and drugs (D&C Act, 1945, guidelines)', 'Code of pharmaceutical ethics and pharmacist oath', 'Ethical principles – profession', 'Slip Test / Activity – Demo'] },
      { name: 'Module 6 – Medical, Trade and Professional Ethics & Introduction to Dosage Forms', week: 'Week 6 (Jul 20th – Jul 24th)', objective: 'Understand professional ethics and identify basic dosage forms of drugs.', days: ['Ethical principles – Medical profession', 'Ethical principles – Trade', 'Introduction to dosage forms of drugs', 'Types of dosage forms based on physical state', 'Slip Test/Activity – Presenting Ethical Principles'] },
      { name: 'Module 7 – Dosage Forms by Route of Administration & Biomedical Waste Management', week: 'Week 7 (Jul 27th – Jul 31st)', objective: 'Identify dosage forms by route of administration and understand biomedical waste management.', days: ['Dosage forms based on route of administration', 'Practical: Identifying dosage forms of drugs', 'Introduction to biomedical waste management', 'Objectives and types of biomedical waste management', 'Slip Test/Activity – Pharmacy Dosage Form Hunt'] },
      { name: 'Module 8 – Biomedical Waste Segregation & Handling of Medicines', week: 'Week 8 (Aug 3rd – Aug 7th)', objective: 'Practise biomedical waste segregation and understand medicine handling and generic vs. brand names.', days: ['Purpose of biomedical waste management', 'Practical – Biomedical waste segregation into colour bins', 'Introduction to handling medications, brand and generic names', 'Theory: Reading ingredients written on medicine', 'Slip Test/Activity – "Waste Sorting Challenge"'] },
      { name: 'Module 9 – Drug Labels, Ingredients, Batch Numbers, Expiry Dates & Shelf Life', week: 'Week 9 (Aug 10th – Aug 14th)', objective: 'Interpret drug labels, batch numbers, expiry dates, and calculate shelf life.', days: ['Holiday', 'Practical: Interpreting drug facts label', 'Identifying batch number and expiry date of medicines', 'Shelf life calculation of given inventory', 'Activity/Slip Test – Identifying ingredients on a given label'] },
      { name: 'Module 10 – Prescription: Parts, Legality, Handling and Patient Communication', week: 'Week 10 (Aug 17th – Aug 21st)', objective: 'Understand prescription parts, legality, and basic patient communication in dispensing.', days: ['Brief introduction to prescription with definitions', 'Parts of a prescription and visualization', 'Legality and handling of prescription', 'Practical: Handling of prescription, communication, and patient interaction', 'Slip Test/Activity – "Valid or Invalid?" Prescription'] },
      { name: 'Module 11 – Dispensing Labels, Drug Safety, Therapeutic and Side Effects', week: 'Week 11 (Aug 24th – Aug 28th)', objective: 'Understand dispensing labels, drug safety principles, therapeutic effects, and side effects.', days: ['Labelling of dispensed medications', 'Theory and practical – principles of safety and health hazard measures of drugs', 'Therapeutic effects and side effects of drugs', 'Sports Day', 'Slip Test/Activity – JAM'] },
      { name: 'Module 12 – Adverse Drug Effects and Medication Errors', week: 'Week 12 (Aug 31st – Sep 4th)', objective: 'Identify adverse drug effects and understand the types and consequences of medication errors.', days: ['Therapeutic effects and side effects (recap)', 'Adverse effects of a drug', 'Medication errors: definition, types, and consequences', 'Film Show', 'Holiday – Krishnastami'] },
      { name: 'Module 13 – Prevention of Medication Errors, LASA Drugs and Tallman Lettering', week: 'Week 13 (Sep 7th – Sep 11th)', objective: 'Apply strategies to minimize medication errors and identify LASA drugs using Tallman lettering.', days: ['Strategies to minimize medication errors', 'Theory: History and importance of LASA drugs', 'Theory: Tallman lettering as per ISMP', 'Practical: Identifying LASA drugs and Tallman lettering', 'Slip Test/Activity – "5 Safety Checks" Before Dispensing Medicines'] },
      { name: 'Module 14 – Drug Interactions and Contraindications', week: 'Week 14 (Sep 14th – Sep 18th)', objective: 'Understand drug interactions and contraindications and their clinical significance.', days: ['Holiday – Vinaya Chaturthi', 'Drug interactions – theory and practical', 'Drug contraindications – theory', 'Drug contraindications – practical', 'Slip test'] },
      { name: 'Module 15 – Safe Medication Use, Drug Schedules and OTC Medicines', week: 'Week 15 (Sep 21st – Sep 25th)', objective: 'Understand safe medication use, drug schedules, and the role of OTC medicines.', days: ['Theory – Ways to make medication use safer', 'Schedules – A to Z', 'Schedule H and restricted medicines (theory and practical)', 'OTC medications – definition and role of pharmacist', 'Slip Test/Activity – "3-Minute Counselling" on OTC Drugs; World Pharmacist Day'] },
      { name: 'Module 16 – OTC Medicines, Self-Medication and Management of Minor Ailments', week: 'Week 16 (Sep 28th – Oct 2nd)', objective: 'Counsel on OTC medicines, self-medication practices, and responding to minor ailments.', days: ['OTC medications in India and counselling', 'Self-medication practice (theory and practical)', 'Responding to symptoms and minor ailments (1–10 types)', 'Internship', 'Internship'] },
      { name: 'Module 17 – Medicinal Compounds: CNS and Autonomic Nervous System Drugs', week: 'Week 19 (Oct 19th – Oct 23rd)', objective: 'Identify categories, uses, side effects, and formulations of CNS and ANS drugs.', days: ['Introduction to categories of medicinal compounds', 'Holiday – Dussehra', 'CNS drugs – category, uses, side effects, storage conditions, formulation types, and brand names', 'Drugs acting on the autonomic nervous system', 'Slip Test'] },
      { name: 'Module 18 – Cardiovascular, Anti-Infective, Diuretic and Hypoglycaemic Drugs', week: 'Week 20 (Oct 26th – Oct 30th)', objective: 'Understand drug classes acting on the cardiovascular system and related therapeutic areas.', days: ['Drugs acting on the cardiovascular system', 'Anti-infective agents', 'Diuretics', 'Hypoglycaemic agents', 'Slip Test/Activity – Flow Chart Preparations'] },
      { name: 'Module 19 – Analgesic, Anti-Inflammatory, Hypoglycaemic Agents and Antibiotics', week: 'Week 21 (Nov 2nd – Nov 6th)', objective: 'Identify analgesic, anti-inflammatory, hypoglycaemic agents, and antibiotics.', days: ['Analgesic and anti-inflammatory agents', 'Hypoglycaemic agents', 'Analgesic and anti-inflammatory agents (continued)', 'Antibiotics', 'Slip Test/Activity – Flow Chart Preparations'] },
      { name: 'Module 20 – Inventory Control, FIFO/FEFO and Safe Disposal of Medicines', week: 'Week 22 (Nov 9th – Nov 13th)', objective: 'Apply FIFO/FEFO methods for inventory control and safe disposal of expired or hazardous medicines.', days: ['Introduction to inventory control; medicine arrangement using FIFO and FEFO methods (theory)', 'Practical – Medicine arrangement using FIFO and FEFO methods', 'Expiry drug removal, handling, and disposal of narcotic drugs', 'Expiry drug removal, handling, and disposal of cytotoxic drugs', 'Slip Test/Activity'] },
      { name: 'Module 21 – Pharmacy Documentation, Stock Ledger and Expiry Management', week: 'Week 23 (Nov 16th – Nov 20th)', objective: 'Maintain purchase records, stock ledgers, and expiry date data accurately.', days: ['Documentation – purchase and inventory', 'Maintaining stock ledger availability of medicine', 'Practical: Maintaining stock ledger data and expiry data', 'Maintaining data as per expiry date of medicine', 'Slip Test/Activity – "Update the Stock Ledger"'] },
      { name: 'Module 22 – Sales Register, Purchase Orders, Computer Applications and Pricing', week: 'Week 24 (Nov 23rd – Nov 27th)', objective: 'Maintain sales and purchase records and use computer applications for pharmacy data management.', days: ['Maintaining sale register after every day distribution of medicine', 'Placing purchase orders as per requirement', 'Use of computer in pharmacy (MS Word, Excel)', 'Calculating purchase price and setting sale price', 'Slip Test/Activity – Prepare an Excel sheet for pharmacy data maintenance'] },
      { name: 'Module 23 – Injection Techniques, Stethoscope and Medicine Expiry Management', week: 'Week 25 (Nov 30th – Dec 4th)', objective: 'Understand injection techniques, stethoscope use, and practice medicine expiry management.', days: ['Introduction, methods of injection techniques, and precautions', 'Practical – Injection technique', 'Stethoscope – theory', 'Practical – Operations and uses of stethoscope', 'Activity/Slip Test – Arrange medicines by expiry date'] },
      { name: 'Module 24 – First Aid, First Aid Equipment, Sterilization and Bandaging', week: 'Week 26 (Dec 7th – Dec 11th)', objective: 'Demonstrate first aid procedures, sterilization methods, and basic bandaging techniques.', days: ['First aid – theory', 'First aid equipment and sterilization methods', 'Practical: First aid practice for different injuries', 'Bandages – theory and practical', 'Slip Test/Activity – First Aid Emergency Station'] },
      { name: 'Module 25 – EAMCET Tips and Final Examination Preparation', week: 'Weeks 27–28 (Dec 14th – Jan 1st)', objective: 'Revise course content and prepare for the final examination through EAMCET-style revision sessions.', days: ['Revision with EAMCET Class (Dec 14–17) – 4 sessions', 'Slip Test (Dec 18)', 'Revision with EAMCET Class (Dec 21–23) – 3 sessions; Holiday – Christmas (Dec 25)', 'Revision with EAMCET Class (Dec 28–31) – 4 sessions', 'Holiday – New Year (Jan 1)'] },
    ],
    extraWeeks: [
      { label: 'Pharmacy Internship – Practical Training (Week 17: Oct 5th – Oct 10th)', items: ['Internship', 'Internship', 'Internship', 'Internship', 'Internship'] },
      { label: 'Pharmacy Internship and Assignment Preparation (Week 18: Oct 12th – Oct 16th)', items: ['Internship', 'Internship', 'Internship', 'Internship', 'Internship Assignment preparation'] },
    ],
    teachingMethods: ['Classroom lectures and interactive discussions', 'PowerPoint presentations and visual demonstrations', 'Practical demonstrations', 'Supervised hands-on practice', 'Role plays and patient-interaction activities', 'Case-based learning', 'Flash cards and educational games', 'Slip tests and weekly assessments', 'Group activities and presentations', 'Pharmacy-based demonstrations', 'Prescription-reading exercises', 'Medicine identification activities', 'Inventory and documentation exercises', 'Computer-based Excel and documentation practice', 'First-aid and bandaging demonstrations', 'Internship and workplace-based learning', 'Revision sessions', 'Assignments and practical assessments'],
    assessmentPlan: [
      { item: 'Written / Slip Tests', weight: '15 marks' },
      { item: 'Practical Skills & Demonstrations', weight: '25 marks' },
      { item: 'Activity-Based Assessments', weight: '10 marks' },
      { item: 'Prescription & Medicine Label Interpretation', weight: '10 marks' },
      { item: 'Drug Identification & Drug Information', weight: '10 marks' },
      { item: 'Inventory & Stock Management Practical', weight: '10 marks' },
      { item: 'Assignments / Projects', weight: '10 marks' },
      { item: 'Internship Performance', weight: '10 marks' },
    ],
    outcomes: [
      'Perform the basic duties of a pharmacy assistant safely, ethically, accurately, and professionally.',
      'Assist in dispensing and handling medicines under pharmacist supervision.',
      'Maintain pharmacy records, stock ledgers, and inventory accurately.',
      'Interpret drug labels, identify dosage forms, and recognize LASA drugs.',
      'Handle prescriptions, understand their components, and communicate with patients.',
      'Apply FIFO/FEFO methods and manage expiry dates and biomedical waste safely.',
      'Understand drug categories, therapeutic effects, side effects, and contraindications.',
      'Monitor blood pressure and blood glucose and understand basic clinical measurements.',
      'Demonstrate first aid, bandaging, and injection techniques.',
      'Use MS Word and Excel for basic pharmacy data entry and documentation.',
      'Communicate effectively with patients, pharmacists, and healthcare team members.',
    ],
  },
